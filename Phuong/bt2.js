...
const daysUntil2023 = (dateString) => {
  ...
  const firstDate2023 = new Date("1/1/2023");
  return `${(firstDate2023.getTime() - inputDate.getTime()) / 86400000}`;
};
